      ...
      <AnimationContainer delay={0.1}>
        <div className="flex flex-col items-center justify-center py-10 max-w-lg mx-auto">
          ...
          <p className="text-base md:text-lg mt-6 text-center text-muted-foreground">
            At Nexcentuari, we specialize in crafting bespoke software, from
            high-performance web applications to AI-powered, offline-first
            Desktop POS systems. We deliver scalable solutions that solve real
            operational challenges and drive growth.
          </p>
        </div>
      </AnimationContainer>
                ...
                >
                  ...
                  <div className="flex gap-2 mb-4">
                    {project.tags.map((tag) => (
                      <span
                        key={tag}
                        className="text-[10px] font-bold tracking-widest uppercase text-muted-foreground/80"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <Link
                    href={`/services/custom-software/projects/${project.id}`}
        ...
        <div className="mt-24 grid grid-cols-1 md:grid-cols-2 gap-16 items-center border-t border-border/50 pt-20">
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              At Nexcentuari, we leverage the latest modern technologies to
              build fast, secure, and smart systems.
            </p>
            <div className="space-y-4">
              {[
                {
                  title: "React & Electron.js",
                  desc: "Building beautiful web interfaces and powerful cross-platform desktop applications (like modern POS systems).",
                },
                {
                  title: "Node.js & Local DBs",
                  desc: "Creating fast, offline-first backend systems and robust local databases for seamless performance.",
                },
                {
                  title: "Cloud & Firebase Sync",
                  desc: "Ensuring real-time data synchronization, cloud backups, and secure hardware licensing.",
                },
                {
                  title: "AI & Smart Automations",
                  desc: "Implementing intelligent features like AI-driven inventory prediction and data analytics.",
                },
              ].map((detail, i) => (
          ...
          <div className="bg-primary/5 rounded-[2.5rem] p-10 border border-primary/10 relative overflow-hidden group">
            ...
            <p className="text-muted-foreground italic">
              We don&apos;t just deliver software; we architect scalable custom
              solutions that solve real-world operational challenges and drive
